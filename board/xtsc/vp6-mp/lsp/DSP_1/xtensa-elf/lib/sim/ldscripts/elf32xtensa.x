/* This linker script generated from xt-genldscripts.tpp for LSP /home/rajivr/wsp/rajiv1/OpenCL/LSP_build/sys-x86_64-linux/subsys.xtsys/package/cores/DSP_1/xtensa-elf/lib/sim */
...
MEMORY
{
  ...
  sysrom0_seg :                       	org = 0xD03B3334, len = 0x333334
  sysram0_seg :                       	org = 0xE0000000, len = 0x300
  sysram1_seg :                       	org = 0xE66668C0, len = 0x4
  sysram2_seg :                       	org = 0xE66668CC, len = 0x334
  sysram3_seg :                       	org = 0xE6666C00, len = 0x180
  sysram4_seg :                       	org = 0xE6666D80, len = 0x40
  sysram5_seg :                       	org = 0xE6666DC0, len = 0x40
  sysram6_seg :                       	org = 0xE6666E00, len = 0x40
  sysram7_seg :                       	org = 0xE6666E40, len = 0x40
  sysram8_seg :                       	org = 0xE6666E80, len = 0x80
  sysram9_seg :                       	org = 0xE6666F00, len = 0x6665F9C
}
...
_memmap_mem_sysrom_start = 0xd03b3334;
_memmap_mem_sysrom_end   = 0xd06e6668;
_memmap_mem_sysram_start = 0xe0000000;
_memmap_mem_sysram_end   = 0xecccce9c;
...
_memmap_seg_sysrom0_start = 0xd03b3334;
_memmap_seg_sysrom0_max   = 0xd06e6668;
_memmap_seg_sysram0_start = 0xe0000000;
_memmap_seg_sysram0_max   = 0xe0000300;
_memmap_seg_sysram1_start = 0xe66668c0;
_memmap_seg_sysram1_max   = 0xe66668c4;
_memmap_seg_sysram2_start = 0xe66668cc;
_memmap_seg_sysram2_max   = 0xe6666c00;
_memmap_seg_sysram3_start = 0xe6666c00;
_memmap_seg_sysram3_max   = 0xe6666d80;
_memmap_seg_sysram4_start = 0xe6666d80;
_memmap_seg_sysram4_max   = 0xe6666dc0;
_memmap_seg_sysram5_start = 0xe6666dc0;
_memmap_seg_sysram5_max   = 0xe6666e00;
_memmap_seg_sysram6_start = 0xe6666e00;
_memmap_seg_sysram6_max   = 0xe6666e40;
_memmap_seg_sysram7_start = 0xe6666e40;
_memmap_seg_sysram7_max   = 0xe6666e80;
_memmap_seg_sysram8_start = 0xe6666e80;
_memmap_seg_sysram8_max   = 0xe6666f00;
_memmap_seg_sysram9_start = 0xe6666f00;
_memmap_seg_sysram9_max   = 0xecccce9c;

_rom_store_table = 0;
_ResetTable_base = 0xe66668bc;
PROVIDE(_ResetTable_base = 0xe66668bc);
PROVIDE(_memmap_reset_vector = 0xe0000000);
PROVIDE(_memmap_vecbase_reset = 0xe6666c00);
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0xecccce90);
  _heap_sentry = 0xecccce90;
  .debug  0 :  { *(.debug) }
  .line  0 :  { *(.line) }
