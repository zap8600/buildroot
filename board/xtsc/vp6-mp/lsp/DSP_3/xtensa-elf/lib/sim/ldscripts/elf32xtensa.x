/* This linker script generated from xt-genldscripts.tpp for LSP /home/rajivr/wsp/rajiv1/OpenCL/LSP_build/sys-x86_64-linux/subsys.xtsys/package/cores/DSP_3/xtensa-elf/lib/sim */
...
MEMORY
{
  ...
  sysrom0_seg :                       	org = 0xD0A1999C, len = 0x333334
  sysram0_seg :                       	org = 0xE0000000, len = 0x300
  sysram1_seg :                       	org = 0xE66668C8, len = 0x4
  sysram2_seg :                       	org = 0xF3333468, len = 0x398
  sysram3_seg :                       	org = 0xF3333800, len = 0x180
  sysram4_seg :                       	org = 0xF3333980, len = 0x40
  sysram5_seg :                       	org = 0xF33339C0, len = 0x40
  sysram6_seg :                       	org = 0xF3333A00, len = 0x40
  sysram7_seg :                       	org = 0xF3333A40, len = 0x40
  sysram8_seg :                       	org = 0xF3333A80, len = 0x80
  sysram9_seg :                       	org = 0xF3333B00, len = 0x6665F34
}
...
_memmap_mem_sysrom_start = 0xd0a1999c;
_memmap_mem_sysrom_end   = 0xd0d4ccd0;
_memmap_mem_sysram_start = 0xe0000000;
_memmap_mem_sysram_end   = 0xf9999a34;
...
_memmap_seg_sysrom0_start = 0xd0a1999c;
_memmap_seg_sysrom0_max   = 0xd0d4ccd0;
_memmap_seg_sysram0_start = 0xe0000000;
_memmap_seg_sysram0_max   = 0xe0000300;
_memmap_seg_sysram1_start = 0xe66668c8;
_memmap_seg_sysram1_max   = 0xe66668cc;
_memmap_seg_sysram2_start = 0xf3333468;
_memmap_seg_sysram2_max   = 0xf3333800;
_memmap_seg_sysram3_start = 0xf3333800;
_memmap_seg_sysram3_max   = 0xf3333980;
_memmap_seg_sysram4_start = 0xf3333980;
_memmap_seg_sysram4_max   = 0xf33339c0;
_memmap_seg_sysram5_start = 0xf33339c0;
_memmap_seg_sysram5_max   = 0xf3333a00;
_memmap_seg_sysram6_start = 0xf3333a00;
_memmap_seg_sysram6_max   = 0xf3333a40;
_memmap_seg_sysram7_start = 0xf3333a40;
_memmap_seg_sysram7_max   = 0xf3333a80;
_memmap_seg_sysram8_start = 0xf3333a80;
_memmap_seg_sysram8_max   = 0xf3333b00;
_memmap_seg_sysram9_start = 0xf3333b00;
_memmap_seg_sysram9_max   = 0xf9999a34;

_rom_store_table = 0;
_ResetTable_base = 0xe66668bc;
PROVIDE(_ResetTable_base = 0xe66668bc);
PROVIDE(_memmap_reset_vector = 0xe0000000);
PROVIDE(_memmap_vecbase_reset = 0xf3333800);
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0xf9999a30);
  _heap_sentry = 0xf9999a30;
  .debug  0 :  { *(.debug) }
  .line  0 :  { *(.line) }
