/* This linker script generated from xt-genldscripts.tpp for LSP /home/rajivr/wsp/rajiv1/OpenCL/LSP_build/sys-x86_64-linux/subsys.xtsys/package/cores/DSP_0/xtensa-elf/lib/sim */
...
MEMORY
{
  ...
  sysrom0_seg :                       	org = 0xD0080000, len = 0x333334
  sysram0_seg :                       	org = 0xE0000000, len = 0x300
  sysram2_seg :                       	org = 0xE0000400, len = 0x180
  sysram3_seg :                       	org = 0xE0000580, len = 0x40
  sysram4_seg :                       	org = 0xE00005C0, len = 0x40
  sysram5_seg :                       	org = 0xE0000600, len = 0x40
  sysram6_seg :                       	org = 0xE0000640, len = 0x40
  sysram7_seg :                       	org = 0xE0000680, len = 0x80
  sysram8_seg :                       	org = 0xE0000700, len = 0x66661B9
  sysram10_seg :                      	org = 0xE66668BC, len = 0x4
}
...
PHDRS
{
  ...
  sysram8_bss_phdr PT_LOAD;
  sysram9_phdr PT_LOAD;
  sysram10_phdr PT_LOAD;
}
...
_memmap_mem_sysrom_start = 0xd0080000;
_memmap_mem_sysrom_end   = 0xd03b3334;
_memmap_mem_sysram_start = 0xe0000000;
_memmap_mem_sysram_end   = 0xe66668c0;
...
_memmap_seg_sysrom0_start = 0xd0080000;
_memmap_seg_sysrom0_max   = 0xd03b3334;
_memmap_seg_sysram0_start = 0xe0000000;
_memmap_seg_sysram0_max   = 0xe0000300;
_memmap_seg_sysram2_start = 0xe0000400;
_memmap_seg_sysram2_max   = 0xe0000580;
_memmap_seg_sysram3_start = 0xe0000580;
_memmap_seg_sysram3_max   = 0xe00005c0;
_memmap_seg_sysram4_start = 0xe00005c0;
_memmap_seg_sysram4_max   = 0xe0000600;
_memmap_seg_sysram5_start = 0xe0000600;
_memmap_seg_sysram5_max   = 0xe0000640;
_memmap_seg_sysram6_start = 0xe0000640;
_memmap_seg_sysram6_max   = 0xe0000680;
_memmap_seg_sysram7_start = 0xe0000680;
_memmap_seg_sysram7_max   = 0xe0000700;
_memmap_seg_sysram8_start = 0xe0000700;
_memmap_seg_sysram8_max   = 0xe66668b9;
_memmap_seg_sysram10_start = 0xe66668bc;
_memmap_seg_sysram10_max   = 0xe66668c0;

_rom_store_table = 0;
_ResetTable_base = 0xe66668bc;
PROVIDE(_ResetTable_base = 0xe66668bc);
PROVIDE(_memmap_reset_vector = 0xe0000000);
PROVIDE(_memmap_vecbase_reset = 0xe0000400);
...
SECTIONS
{
  ...
  .Level2InterruptVector.literal : ALIGN(4)
  {
    ...
    *(.Level2InterruptVector.literal)
    ...
    _memmap_seg_sysram2_end = ALIGN(0x8);
  } >sysram2_seg :sysram2_phdr
  ...
  } >sysram8_seg :sysram8_bss_phdr

  PROVIDE(__stack = 0xe66668b0);
  _heap_sentry = 0xe66668b0;
  ...
  .ResetTable.rodata : ALIGN(4)
  {
    ...
    *(.ResetTable.rodata)
    ...
    _memmap_seg_sysram10_end = ALIGN(0x8);
  } >sysram10_seg :sysram10_phdr
